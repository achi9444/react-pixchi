                ...
                <section className='coner'>
                    ...
                    <div className="conOut">
                        <div className='conBox conBox1'>
                            ...
                            <img src="./train.webp" alt="train" loading="lazy" />
                        </div>
                        <div className='conBox conBox2'>
                            ...
                            <div className='box2_2'>
                                <img src="./flower.webp" alt="cuteRabbit" loading="lazy" />
                                <img src="./mochi.webp" alt="cuteRabbit" loading="lazy" />
                            </div>
                        </div>
                        <div className="conBox conBox3">
                            ...
                            <img src="./focus.webp" alt="focus" loading="lazy" />
                        </div>
                    </div>
                    <NavLink to={'/HealingCorner'} className={'toCor'}>
                        探索角落<img src="./more.webp" alt="more" loading="lazy" />
                    </NavLink>
                </section>
                <section className='myJourney'>
                    <div className='jouBg'>
                        ...
                        <div className='jouText'>
                            <p className='desc1 text1'>被限制在兩點一線的軌跡，我的世界很小<br />《新楓之谷》成了我的宇宙<br />在像素裡冒險、打怪、升級，過著自己嚮往的生活<br />拼豆成了我的創作語言<br />一顆顆地拼湊心情，也拼湊想像中的自己<br />家人不理解，只覺得是浪費時間的「玩具」<br />但這是我靜靜陪伴自己的方式<br />這裡，收藏了那些被質疑的片段</p>
                            <p className='desc2 text2'>若你願意停下腳步，也許你會拼湊出新的自己</p>

                            <p className='desc1 text3'>被限制在兩點一線的軌跡<br />我的世界很小<br />《新楓之谷》成了我的宇宙<br />在像素裡冒險、打怪、升級<br />過著自己嚮往的生活<br />拼豆成了我的創作語言<br />一顆顆地拼湊心情<br />也拼湊想像中的自己<br />家人不理解<br />只覺得是浪費時間的「玩具」<br />但這是我靜靜陪伴自己的方式<br />這裡，收藏了那些被質疑的片段</p>
                            <p className='desc2 text4'>若你願意停下腳步<br />也許你會拼湊出新的自己</p>
                            <NavLink to={'/About'}>
                                更多故事<img src="./more.webp" alt="more" loading="lazy" />
                            </NavLink>
                        </div>
                    </div>
                </section>
